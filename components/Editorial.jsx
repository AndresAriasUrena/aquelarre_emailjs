...
const Editorial = ({post}) => {
  return (
    ...
    <div className='relative h-60 md:h-96 lg:h-60'>
        <div className="absolute bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-60 md:h-96 lg:h-60" style={{ backgroundImage: ` url(${post.foto})`/* backgroundImage: `url('${post.imagenPresentacion.url}')` */}} />
