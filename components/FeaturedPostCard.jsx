...
const FeaturedPostCard = ({ post }) => (
  <div className="relative h-60 md:h-96 lg:h-[31rem]">
    <div className="absolute bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-60 md:h-96 lg:h-[31rem]" style={{ backgroundImage: `url('${post.imagenPresentacion.url}')` }} />
