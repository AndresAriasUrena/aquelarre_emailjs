...
const FeaturedPostCard = ({ post }) => (
  <div className="relative h-60 md:h-96 lg:h-[26rem]">
    <div className="absolute bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-60 md:h-96 lg:h-[26rem]" style={{ backgroundImage: `url('${post.imagenPresentacion.url}')` }} />
    <div className="absolute bg-center bg-gradient-to-b opacity-50 from-gray-400 via-gray-700 to-black w-full h-60 md:h-96 lg:h-[26rem]" />
